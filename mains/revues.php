...
<section class="w3l-service-breadcrum" style="background-color:black;">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
        <h2>Nos révues</h2>
      <p><a href="accueil">accueil</a> &nbsp; / &nbsp; Revues</p>
   </div>
  </div>
</section>
 <!--  services section -->
  ...
  <div class="features-with-17_sur py-5">
    <div class="container py-lg-3">
      <div class="features-with-17-top_sur">
        <div class="row">
        <?php 
          $myqwery=$db->prepare("SELECT rapport.id,rapport.designation as d,rapport.pdf,rapport.rpt,rapport.date, categorie_r.id as ids,categorie_r.designation from rapport INNER JOIN categorie_r ON rapport.rpt = categorie_r.id WHERE rpt=2 ORDER BY id DESC ");
          $myqwery->execute();
          ...
          <div class="col-lg-4 col-md-6 mt-md-0 mt-4 ">
            <div class="features-with-17-right-tp_sur shadow">
              <div class="features-with-17-left1 mb-3">
                <span class="fa fa-book" aria-hidden="true" style="color: rgb(101,179,254);"></span>
              </div>
