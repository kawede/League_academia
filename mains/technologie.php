...
<div class="locations py-5">
 <div class="container py-md-3">
    <div class="heading text-center mx-auto">
        <h3 class="head">Technologie</h3>
        <p class="my-3 head "> Trouvez-ici toutes les informations liées à la technologie</p>
      </div>
      <hr>
      <br>
      <div class="card-deck">
        <?php 
          $myqwery=$db->prepare("SELECT * FROM article WHERE categorie =6  ORDER BY id DESC");
          $myqwery->execute();
